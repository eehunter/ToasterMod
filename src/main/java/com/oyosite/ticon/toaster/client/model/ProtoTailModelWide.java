...
public class ProtoTailModelWide extends BipedEntityModel<LivingEntity> {
    ...
    public ProtoTailModelWide() {
        ...
        cube_r3.setTextureOffset(0, 0).addCuboid(-3.0F, -4.0F, 0.0F, 4.0F, 4.0F, 6.0F, 0.2F, false);bone4 = new ModelPart(this);
        ...
        cube_r4.setTextureOffset(0, 10).addCuboid(-3.0F, -2.4965F, 1.2314F, 6.0F, 4.0F, 6.0F, 0.0F, false);
        ...
        cube_r5.setTextureOffset(22, 0).addCuboid(-3.0F, -2.934F, -1.0355F, 6.0F, 4.0F, 6.0F, -0.2F, false);

        bone12 = new ModelPart(this);
        bone12.setPivot(0.0F, 0.0F, 0.0F);
        bone5.addChild(bone12);
        bone12.setTextureOffset(24, 10).addCuboid(-2.5F, -0.375F, 15.9356F, 5.0F, 4.0F, 6.0F, -0.4F, false);
    }
